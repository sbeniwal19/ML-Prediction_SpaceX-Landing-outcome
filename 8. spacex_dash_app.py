...
def get_scatter (site, slider_position):
    ...
    if site == 'ALL':
        ...
        scatter_df1 = scatter_df[scatter_df['Launch Site'] == site]
        fig = px.scatter(scatter_df1, x="Payload Mass (kg)", y="class", color="Booster Version Category",
